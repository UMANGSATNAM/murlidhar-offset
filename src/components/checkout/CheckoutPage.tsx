              ...
              <Card className="premium-shadow">
                ...
                <CardContent className="space-y-6">
                  ...
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-xl border-2 transition-all ${
                      paymentMethod === 'razorpay'
                        ? 'border-gold bg-gold-muted gold-border'
                        : 'border-border hover:border-gold/30'
                    }`}
                  >
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                        paymentMethod === 'razorpay' ? 'bg-navy' : 'bg-muted'
                      }`}>
                        <Wallet className={`size-6 ${paymentMethod === 'razorpay' ? 'text-gold' : 'text-muted-foreground'}`} />
                      </div>
                      ...
                      <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                        paymentMethod === 'razorpay' ? 'border-gold' : 'border-muted-foreground'
                      }`}>
                        {paymentMethod === 'razorpay' && <div className="w-2.5 h-2.5 rounded-full bg-gold" />}
                      </div>
                    </div>
                  </button>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                        paymentMethod === 'cod' ? 'bg-navy' : 'bg-muted'
                      }`}>
                        <Banknote className={`size-6 ${paymentMethod === 'cod' ? 'text-gold' : 'text-muted-foreground'}`} />
                      </div>
                      <div className="flex-1">
