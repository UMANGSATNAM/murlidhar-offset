      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-2xl bg-navy mx-auto flex items-center justify-center mb-4 navy-shadow">
              <span className="text-2xl font-bold text-gold">M</span>
            </div>
            <h1 className="text-2xl font-bold text-foreground">Murlidhar Offset</h1>
            <p className="text-sm text-muted-foreground mt-1">Premium Offset Printing Solutions</p>
          </div>
